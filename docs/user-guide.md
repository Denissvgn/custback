...
[Quick start](../README.md) · [Configuration](../config/default.yaml)
...
camera-device source. File and URL streams are rejected. Synthetic inputs
...
[Experimental system profiles](system-profiles.md).
...
[operator guide](matte-operator-mitigations.md#runtime-performance-recommendation)
...
See [Experimental system profiles](system-profiles.md).
...
runbook is [Two-host avatar deployment](remote-deployment.md). It defines
...
[npm installation](#npm-launcher-ubuntu--debian-and-macos); npm removes that directory before a new
